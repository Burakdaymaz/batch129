...
public class WrapperClass {
    ...
    public static void main(String[]args) {
        ...
        //primitive: char - booleon - byte -short - int - long - float - double
        ...
        Integer m = 12;//"m" yazip"nokta"koyarsaniz bircok method görürsünüz ,cünkü "wrapper class"lar method icerir
        ...
        //Example 3: i)Primitive int`i Wrapper Interger`a ceviriniz.(Autoboxing)
        int nun = 22;
        ...
        //Java`da "+" sembolu iki String arasinda veya bir String  ve bir sayi arasinda kullanirsa "concatenation islemi" olur.
