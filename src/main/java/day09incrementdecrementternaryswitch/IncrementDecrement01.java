...
public class IncrementDecrement01 {
    ...
    public static void main(String[]args){
       ...
       // f += 1;
        ...
        //"post increment" ve "pre-incremnet"
        int i  = 10;
        int k = i++;// post-increment cunku increment, variable`in isminden sana yazildi
        ...
        System.out.println(n);// 16 ==> "n" artirildiktan sonra "n" ye konuldugu icin "n" nin degeri 16 olur.
