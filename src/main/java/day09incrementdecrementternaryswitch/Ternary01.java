...
public class Ternary01 {
    ...
    public static void main(String[]args){
       ...
       System.out.println(r2);//4
        ...
        //Example 3: iki sayininin isareti ayni ise bu sayilari carpan, isaretleri farkli ise "Farkli isaretli sayilari carpamiyorum"
        ...
        //Farkli data type`lari icin ortak bir variabla olusturmak istediginizde, data type olarak object kullanabilirsiniz.
        //Java`da "Object", insanlik aleminde "Hz.Adem" e benzer.

        Object r3 = (m>0 && n>0) |    (m<0 && n<0)  ?  m*n : "Farkli isaretli sayilari carpamiyor";
        ...
        String r4 = r>99 && r<1000 ? p + " uc basamakli " : p + "uc basamakli degildir";
