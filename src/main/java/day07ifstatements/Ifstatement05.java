...
public class Ifstatement05 {
    ...
    public static void main(String[]args) {
        ...
        Niye ?
        Cunku; "==" sembolu iki String`i karsilarken hem adreslerlerine hemde degerlerine bakar,
        ikiside ayni ise siz String`ler esittir der ama biz code yazarken genellikle String`lerin
