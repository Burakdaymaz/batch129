...
public class C01_StringManipulation {
 ...
 public static void main(String[]args){
     ...
     System.out.println("ikiyuzkirk"+40*60);//ikiyuzkirk240
     System.out.println(60+40+"Yuz");//100Yuz
     //KUllanicidan ismini sanitising alienize. Kullanici nasil girerse girsin
     ...
     //Verilen cumleyi + ile gizleyip , 10.karakterden sonrasi yazdirin
     ...
     //Verilen bir String de kullanilam noktalama isareti ve rakamler ve space karakteri haric
     //       tum karakterlerin sayisi bulan kodu yaziniz

     String str3="Learn java earn 90000000 money,!...";
     str3=str3.replaceAll("[^\\p{Punct}0-9 ]","");
     int sonuc=str3.length();
