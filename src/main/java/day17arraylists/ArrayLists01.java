...
public class ArrayLists01 {
   ...
   2) ArrayList(List)'ler non-primitive data type'inda ki coklu datalari depolamak icin kullanilir.
     List'ler "nan-primitive" data kabul ederler, "Array"ler ise "primitive" data veya reference kabul eder
   3) ArraysLists(List)'leri olusturun icine koyacaginiz eleman sayisi basta söylemeye gerek yoktur.
