...
public class Exceptions01 {
    ...
    /*
    1)Exceptions demek beklenmedik problem demektir. Seyahatte benzinin bitmesi, arabanin bozulmasi gibi...
    ...
    Application'lardada beklenmedik problemler icin cozum yollari uretmeliyiz, bu isleme "Exception Handling" denir.
    3)Exception'lar temel olarak ikiye ayrilir
        i)Compile Time Exception: Siz code yazarken farkedilir ve yazdiginiz codun alti kirmizi cizgi ilemcizilir.
