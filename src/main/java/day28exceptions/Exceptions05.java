...
public class Exceptions05 {
   ...
   //try kisminda birden fazla Exceptions olusturma ihtimali olan kod varsa, coklu "catch" kullanabilirsiniz.

    //Coklu "catch" kullandiginizda Exceptions Class'lar arasinda "parent - child" iliskisi yoksa, catch'lerin sirasi
    //onemli degildir. Ama kod'daki siralamaya uymak tavsiye edilir.

    //Coklu "catch" kullandiginizda Exceptions Class'lar arasinda "parent - child" iliskisi varsa, catch'lerin sirasi
