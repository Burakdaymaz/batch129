    ...
    /*
     Inheritance'in faydalari;
         ...
         Note 11: Java'da "parent"dan "child"a olan iliskilere "Has-A Relationship" denir.
                 Java'da "child"dan "parent"a olan iliskilere "IS-A Relationsship" denir.
         Note 12: Java'da her class'in bir tane default constructur'i vardir
                 bu default construcktur class'in icinde gorunmez cunku default contructur "Object class" icindir.
                 Bizim class'imiz default constructur'a ihtiyac duydugunda parent olan "Object Class"a gider ve oradaki constructır'ı kullanır.
    */
